...
/*!
 ...
 @abstract
 This API sets the SDK wrapper and the version number of the wrapper.
 
 @discussion
 Do not use this API directly as it is meant only for SDK wrappers.
 */
+ (void) setSDKWrapper:(NSString*)wrapper withVersion:(NSString*) version;
#pragma mark - END METHODS FOR SDK WRAPPERS ONLY
